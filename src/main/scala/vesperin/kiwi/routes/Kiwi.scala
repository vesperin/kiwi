...
import vesperin.kiwi.domain.Command
import vesperin.kiwi.interpret.CommandInterpreter
import vesperin.kiwi.spi._

/**
 * @author hsanchez@cs.ucsc.edu (Huascar A. Sanchez)
 */
trait Kiwi extends HttpService with AsyncSupport with AuthSupport with CORSSupport {
  /**
